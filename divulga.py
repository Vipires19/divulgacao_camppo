...
st.markdown('O chatGPT 4 como na notícia acima foi treinado em abril de 2023, isso por fazer com que o modelo tenho respostas menos precisas se necessário a recorrer a dados que são atualizados anualmente por exemplo.')
